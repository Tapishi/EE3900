...
\item In the circuit, the switch S is connected to position P for a long time so that the charge on the capacitor
	becomes $q_1 \, \mu C$. Then S is switched to position Q.  After a long time, the charge on the capacitor is
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{ckt.png}
			\caption{}
			\label{fig:ckt}
\end{figure}
\item Find $q_1$.
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{2_6.png}
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{3_4.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{4_3.png}
    \caption{Plot of $H(s)$.}
    \label{fig:Hs}
\end{figure}
...
these equalities.
\begin{figure}
    \includegraphics[width=\columnwidth]{4_7.png}
