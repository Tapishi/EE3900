...
\item In the circuit, the switch S is connected to position P for a long time so that the charge on the capacitor
	becomes $q_1 \, \mu C$. Then S is switched
		$q_2 \, \mu C$.
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{ckt.pdf}
			\caption{}
			\label{fig:ckt}
\end{figure}
\item Find $q_1$.
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{2_6.pdf}
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{3_4.pdf}
